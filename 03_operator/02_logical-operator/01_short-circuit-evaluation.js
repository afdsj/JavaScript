/* 01_logical-operator(논리연산자)
||(or), &&(AND), !(NOT)의 논리 연산자는 피연산자를 논리 연산한다
*/

/* 01_short-circuit evalution(단축 평가) 
표현식을 평가하는 도중 평가 결과가 확정 된 경우 평가 과정을 생략하는 것 
*/

/* OR, AND 연산자 표현식의 결과는 때로 boolean의 값이 아닐 수도 있다

OR의 경우 'apple'이 이미 Truthy 값이여서 true로 평가되고
논리 연산이ㅡ 결과를 결정한 첫 번째 피연산자 apple을 그대로 반환한다
*/
