...
console.log(typeof parseInt(arr5[0])); // number
...
for (let index = 0; index < arr.length; index++) {
    console.log(arr[index]); // 총 3개의 인자를 갖는다
    /* arr[3]는 없다 왜냐하면 컴퓨터는 0부터 숫자를 세기 때문이다 */
}
...
/* 
    일반 객체와 배열은 값의 순서와 length property 유무에서 차이가 있다
    인덱스로 표현되는 값의 순서와 length property를 갖는 배열은 반복문을 통해
